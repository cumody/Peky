package com.mahmoudshaaban.peky.features.categories.constants
...
val categoriesList: List<Category> = listOf(
    ...
    Category(
        "Diets",
        listOf(
            CategoryItem("diets","Gluten Free", "https://i0.wp.com/www.diegocoquillat.com/wp-content/uploads/2018/11/sin_gluten2.png?fit=702%2C336&ssl=1"),
            CategoryItem("diets","Ketogenic", "https://i.blogs.es/aa8690/aguacate_huevos/450_1000.jpg"),
            CategoryItem("diets","Vegetarian", "https://i0.wp.com/images-prod.healthline.com/hlcmsresource/images/AN_images/vegetarian-diet-plan-1296x728-feature.jpg?w=1155&h=1528"),
            CategoryItem("diets","Lacto-Vegetarian", "https://s3-us-west-1.amazonaws.com/contentlab.studiod/getty/d817388bbe294ace959d7b55f42fca0e.jpg"),
            CategoryItem("diets","Ovo-Vegetarian", "https://caitlinbenham.weebly.com/uploads/4/5/2/7/45271833/9122438.jpg?305"),
            CategoryItem("diets","Vegan", "https://cdn.loveandlemons.com/wp-content/uploads/2019/12/vegan-recipes-500x375.jpg"),
            CategoryItem("diets","Pescetarian", "https://st4.depositphotos.com/9012638/29097/i/450/depositphotos_290973290-stock-photo-pescetarian-diet-plan-ingredients.jpg"),
            CategoryItem("diets","Paleo", "https://irenamacri.com/wp-content/uploads/2017/05/paleo-shrimp-stir-fry-feature.jpg"),
            CategoryItem("diets","Primal", "https://quediferenciahay.com/wp-content/uploads/2016/11/dieta-paleo-y-dieta-primal-SFW.jpg")
        )
    ),
    Category(
        "Meal Types",
